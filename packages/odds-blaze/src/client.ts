...
export class OddsBlazeClient {
  ...
  private readonly axiosInstances: {
    [K in OddsBlazeSubDomains]: AxiosInstance;
  };
  ...
  public async getOddsStatus(props: OddsStatusProps) {
    return await this.request<OddsStatusResponse>({
